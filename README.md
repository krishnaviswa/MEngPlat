...
**Mobile parity conventions (Tier 2/3, S-057..S-060):** `ThemeToggleButton`/`themeModeProvider`
...
rating-mix bar charts; reuse it for future mobile chart needs (e.g. M-68's trend/delta work)
rather than adding a second charting package.
...
**Rollup (2026-08-18):** `implemented` 51 · `partial` 3 · `unimplemented` 19 · `n/a` 6 · `future` 1 · **total 80**.
