...
| Collect review / merchant QR | — | `CollectQrCard`, `app/collect/[businessId]/page` (UI unchanged S-118; gamified flow **S-119**: `components/collect/gamified/*`, `page.gamified.test.tsx`), `mobile/features/reviews/gamified/*`; `public/.well-known/assetlinks.json` | `collect_review_screen_test.dart`, `collect_review_screen_gamified_test.dart` (**S-119**), `share_review_link_sheet_test.dart` (+ **S-120** print-share case), `app_shell_test.dart` (**S-120** QR shop-resolution cases), `business_collect_resolve_test.dart` | — | TR-S-037–040, 059, 077, **118, 119, 120** |
...
| Theme / chrome / dark contrast | — | `ThemeToggle`, `Navbar`, `Footer`, `app/ClientLayout`, `ui/Select`, `ui/NavLink`, `NavbarMobileMenu` | `app_shell_test.dart`, `theme_toggle_button_test.dart`, `dark_contrast_test.dart`, `widget_test.dart` | — | TR-S-027, 045, 057, 096, 103, 104, 114, **116**, **122** |
