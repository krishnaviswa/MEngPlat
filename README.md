...
**Mobile parity conventions (Tier 2/3/4, S-057..S-061):** `ThemeToggleButton`/`themeModeProvider`
...
rating-mix bar charts; reused as-is by S-061 for the admin platform time-series chart row (no
second charting package added). Repository layer follows one-concern-per-file
...
same existing convention, not a new pattern.
...
| M-66 | Merchant          | Featured listing boost (paid)                                      | Dashboard SKU tiles + search rank + Featured badge | Dashboard SKU catalog + placement status (`FeaturedBoostPanel`) + `BusinessCard` Featured badge | `partial` | S-036/S-042 (web); S-062 (mobile) — browse/display shipped; checkout still web-only, by design |
...
**Rollup (2026-08-18):** `implemented` 54 · `partial` 4 · `unimplemented` 15 · `n/a` 6 · `future` 1 · **total 80**.

#### Mobile parity roadmap

Mobile traffic outweighs web traffic for this product, so the 23 remaining `unimplemented`
...
| 3    | Merchant monetization & analytics   | ~~M-61~~ (Done — S-060, Accepted 2026-08-18), ~~M-66~~ (Done, `partial` — S-062, Accepted 2026-08-18; checkout still web-only), M-68, M-69, M-70, M-78, M-79, M-80      | Revenue and retention for the paying side of the platform.                                                         |
