...
Mobile traffic outweighs web traffic for this product. Original P0–P4 / Tiers 1–5 tracker rows are closed. **S-093–S-095 (2026-08-19)** closed the remaining web-only rows **M-81–M-91**. Still `partial`: M-10 chrome, M-54 Country/State dropdowns (web-only), M-65 in-app reset, M-71 cold QR, M-74 OTP chooser. `future`: FCM. This section
