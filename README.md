...
**Rollup (2026-08-18):** `implemented` 49 · `partial` 2 · `unimplemented` 22 · `n/a` 6 · `future` 1 · **total 80**.
...
| 2    | Core review/discovery UX            | M-72, ~~M-75~~ (Done — S-057, Accepted 2026-08-18), M-71 | Highest-frequency logged-in screens; QR review collection directly drives review volume from mobile users.        |
