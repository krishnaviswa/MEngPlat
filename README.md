...
**Rollup (2026-08-18):** `implemented` 50 · `partial` 2 · `unimplemented` 21 · `n/a` 6 · `future` 1 · **total 80**.
...
| 2    | Core review/discovery UX            | ~~M-72~~ (Done — S-058, Accepted 2026-08-18), ~~M-75~~ (Done — S-057, Accepted 2026-08-18), M-71 | Highest-frequency logged-in screens; QR review collection directly drives review volume from mobile users.        |
