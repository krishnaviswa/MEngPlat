...
**Rollup (2026-08-18):** `implemented` 55 · `partial` 4 · `unimplemented` 14 · `n/a` 6 · `future` 1 · **total 80**.
...
| 3    | Merchant monetization & analytics   | ~~M-61~~ (Done — S-060, Accepted 2026-08-18), ~~M-66~~ (Done, `partial` — S-062, Accepted 2026-08-18; checkout still web-only), ~~M-68~~ (Done — S-063, Accepted 2026-08-18), M-69, M-70, M-78, M-79, M-80      | Revenue and retention for the paying side of the platform.                                                         |
