...
| `DEMO_PHONE_OTP`              | *(empty)*                                                                | Temporary mock-only fixed SMS code (Compose: `123456`). Remove: `docs/agents/REMOVE-ME-demo-fixed-otp.md` |
