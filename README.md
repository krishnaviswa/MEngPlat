...
| Search / categories / home marketing | `test_categories_search.py` | `search/page`, `FeaturedGrid`, `CategoryBadges`, `home/SocialProofRail`, `home/ProblemSection` | `home_screen_test.dart`, `search_controller_test.dart` | `test_flow_anonymous.py`, `test_smoke_compose.py` | TR-S-041, 047, 064, 081, 099, **114** |
...
| Theme / chrome / dark contrast | — | `ThemeToggle`, `Navbar`, `Footer`, `app/ClientLayout`, `ui/Select` | `app_shell_test.dart`, `theme_toggle_button_test.dart`, `dark_contrast_test.dart`, `widget_test.dart` | — | TR-S-027, 045, 057, 096, 103, 104, **114** |
...
| M-11 | Chrome            | Bottom nav / primary shell                                         | — (web uses top nav)                            | `AppShell` `StatefulShellRoute` + `NavigationBar`                      | `implemented`   | S-027 / ADR-005 (S-103 per-tab stacks)                   |
...
| M-15 | Discovery         | City index                                                         | `/` (`CityIndex`)                               | `/home` Neighborhood segment → `/businesses?city=`                     | `implemented`   | S-064; **S-114** segmented with category |
| M-16 | Discovery         | Category index                                                     | `/` (`CategoryIndex`)                           | `/home` Category segment → `/businesses?category=`                     | `implemented`   | S-064; **S-114** segmented with neighborhood |
