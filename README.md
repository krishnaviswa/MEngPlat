...
| Collect review / merchant QR | — | `CollectQrCard`, `app/collect/[businessId]/page` (UI unchanged S-118); `public/.well-known/assetlinks.json` | `collect_review_screen_test.dart`, `share_review_link_sheet_test.dart`, `business_collect_resolve_test.dart` | — | TR-S-037–040, 059, 077, **118** |
