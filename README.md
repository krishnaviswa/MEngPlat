...
**Rollup (2026-08-19):** `implemented` 78 · `partial` 5 (M-10 chrome, M-54 merchant editor Country/State dropdowns on web only — S-084, M-65 reset completion, M-71 cold QR, M-74 phone OTP chooser/admin OTP) · `unimplemented` 0 · `n/a` 7 · `future` 1 · **total 91**.

#### Mobile parity roadmap

Mobile traffic outweighs web traffic for this product. Original P0–P4 / Tiers 1–5 tracker rows are closed. **S-093–S-095 (2026-08-19)** closed the remaining web-only rows **M-81–M-91**. **S-096–S-101** restyle Flutter as job-sized mobile (Figma Mobile `rk4RnruVFTpKdIsgGJIt9w`, not 1:1 web layouts). Still `partial`: M-10 chrome, M-54 Country/State dropdowns (web-only), M-65 in-app reset, M-71 cold QR, M-74 OTP chooser. `future`: FCM. This section
