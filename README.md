...
| Register / login / JWT / Google | `test_api.py`, `test_auth_hardening.py`, `test_google_auth.py`, `test_google_config.py`, `test_s018_s020_login_profile.py` | `LoginForm`, `RegisterForm`, `AlreadySignedIn`, `RequireAuth`, `AuthMethodToggle`, `lib/__tests__/api.test.ts` | `register_google_auth_test.dart`, `google_sign_in_button_test.dart`, `google_client_id_test.dart`, `post_login_path_test.dart`, `widget_test.dart` | `test_flow_anonymous.py`, `test_flow_customer.py`, `test_token_security.py` | TR-S-018, 067, 092, 098, 102, **116** |
...
| Step-up / reauth | `test_reauth.py` | `MerchantNationalIdCard` | `profile_screen_test.dart` | — | TR-S-107, TR-S-114 |
...
| List / edit business, address, hours, onboarding | `test_businesses_mine.py`, `test_business_address_reverify.py`, `test_business_service_summary.py`, `test_business_processing_status.py` | `BusinessForm`, `BusinessHours`, `GooglePlacePicker`, `OnboardingGuidancePanel`, `BusinessPhotoManager` | `business_editor_screen_test.dart`, `country_state_test.dart`, `business_hours_test.dart`, `my_business_ids_provider_test.dart` | `test_flow_merchant.py` | TR-S-069, 073, 074, 075, 079, 084 |
...
| Reviews write / moderate | `test_reviews.py`, `test_content_moderation.py` | `ReviewForm`, `ReviewCard`, `ui/Textarea` | `review_form_sheet_test.dart`, `review_card_test.dart`, `reviews_controller_test.dart`, `rating_stars_test.dart` | `test_flow_customer.py` | TR-S-023, 030 |
...
| Merchant dashboard / analytics / trends | `test_dashboard.py`, `test_dashboard_deltas.py`, `test_benchmark.py` | `MerchantDashboard`, `Dashboard`, `Charts`, `BenchmarkCard`, `ui/StatCard` | `merchant_dashboard_screen_test.dart`, `dashboard_hub_test.dart`, `platform_series_chart_test.dart`, `role_home_screen_test.dart` | `test_flow_merchant.py` | TR-S-022, 033, 060, 063, 100, **117** |
...
| Admin platform / queues / ops nav | `test_admin_platform.py`, `test_admin_platform_asgi.py`, `test_admin_browse.py`, `test_admin_browse_asgi.py`, `test_dashboard.py` (platform keys) | `app/admin/page`, `AdminOpsNav`, `PendingBusinessQueue`, `AllBusinessesQueue`, `AllReviewsQueue`, `drilldown-back-links`, `AdminBackLink` | `admin_home_screen_test.dart`, `admin_route_gating_test.dart`, `admin_copy_test.dart` | `test_flow_admin.py`, `test_rbac_matrix.py` | TR-S-021, 034, 079, 086, 091, 093, 101, **115**, **117** |
| Admin users / categories | (browse + platform files) | `AdminUserPanel`, `AdminCategoryPanel`, `app/admin/page` (Users helper), `app/admin/businesses/page` | `admin_users_screen_test.dart`, `admin_categories_screen_test.dart` | — | TR-S-041, 080, 082, 083, **115** |
