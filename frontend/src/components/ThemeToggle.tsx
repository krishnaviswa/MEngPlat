...
/** ThemeToggle — sun/moon button that flips light/dark, overriding OS preference (S-045). */
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex h-8 w-8 items-center justify-center rounded-full text-muted hover:bg-gray-100 hover:text-ink dark:hover:bg-gray-800"
    >
      {isDark ? (
        <svg
