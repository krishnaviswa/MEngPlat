...
- [ ] README §12 Web ↔ mobile feature parity tracker has a matching row if this ships as a user-facing web capability (typically `unimplemented` / `partial` / `future` on mobile until a later slice)
