...
class MapsApi {
  ...
  Future<Response<GeocodeResponse>> geocodeAddressApiV1MapsGeocodeGet({ 
    ...
    final _path = r'/api/v1/maps/geocode';
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GeocodeResponse),
      ) as GeocodeResponse;
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> mapsConfigApiV1MapsConfigGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/maps/config';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<BusinessResponse>>> nearbyBusinessesApiV1MapsNearbyPost({ 
    required NearbyBusinessRequest nearbyBusinessRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/maps/nearby';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(NearbyBusinessRequest);
      _bodyData = _serializers.serialize(nearbyBusinessRequest, specifiedType: _type);
