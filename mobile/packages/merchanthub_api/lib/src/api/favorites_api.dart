...
class FavoritesApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [FavoriteResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FavoriteResponse>> createFavoriteApiV1FavoritesPost({ 
    ...
    try {
      const _type = FullType(FavoriteCreate);
      _bodyData = _serializers.serialize(favoriteCreate, specifiedType: _type);
    ...
    FavoriteResponse? _responseData;
    ...
    return Response<FavoriteResponse>(
      data: _responseData,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteFavoriteApiV1FavoritesBusinessIdDelete({ 
    ...
    final _path = r'/api/v1/favorites/{business_id}'.replaceAll('{' r'business_id' '}', encodeQueryParameter(_serializers, businessId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<BusinessResponse>>> listFavoritesApiV1FavoritesGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
