...
class AuthenticationApi {
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TokenResponse>> googleAuthApiV1AuthGooglePost({ 
    required GoogleAuthRequest googleAuthRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(GoogleAuthRequest);
      _bodyData = _serializers.serialize(googleAuthRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [MessageResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MessageResponse>> logoutApiV1AuthLogoutPost({ 
  ...
  /// Returns a [Future] containing a [Response] with a [TokenResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TokenResponse>> refreshTokenApiV1AuthRefreshPost({ 
  ...
  /// Returns a [Future] containing a [Response] with a [UserResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserResponse>> registerApiV1AuthRegisterPost({ 
  ...
  /// Returns a [Future] containing a [Response] with a [UserResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserResponse>> updateMeApiV1AuthMePatch({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(userProfileUpdate, specifiedType: _type);
