...
class ReviewsApi {
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ReviewResponse>>> listAdminReviewsApiV1ReviewsAdminAllGet({ 
    String? businessId,
    int? page = 1,
    int? pageSize = 20,
    CancelToken? cancelToken,
    ...
    final _path = r'/api/v1/reviews/admin/all';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      r'business_id': encodeQueryParameter(_serializers, businessId, const FullType(String)),
