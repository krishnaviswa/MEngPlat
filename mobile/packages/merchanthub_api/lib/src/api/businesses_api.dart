...
class BusinessesApi {
  ...
  Future<Response<BusinessResponse>> approveBusinessApiV1BusinessesBusinessIdApprovePost({ 
    ...
    final _path = r'/api/v1/businesses/{business_id}/approve'.replaceAll('{' r'business_id' '}', encodeQueryParameter(_serializers, businessId, const FullType(String)).toString());
  ...
  /// Returns a [Future] containing a [Response] with a [BusinessResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BusinessResponse>> createBusinessApiV1BusinessesPost({ 
    required BusinessCreate businessCreate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/businesses';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(BusinessCreate);
      _bodyData = _serializers.serialize(businessCreate, specifiedType: _type);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CategoryResponse>> createCategoryApiV1BusinessesCategoriesPost({ 
    required CategoryCreate categoryCreate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/businesses/categories';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(CategoryCreate);
      _bodyData = _serializers.serialize(categoryCreate, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [BusinessResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BusinessResponse>> getBusinessApiV1BusinessesSlugGet({ 
    ...
    final _path = r'/api/v1/businesses/{slug}'.replaceAll('{' r'slug' '}', encodeQueryParameter(_serializers, slug, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<CategoryResponse>>> listCategoriesApiV1BusinessesCategoriesAllGet({ 
    ...
    final _path = r'/api/v1/businesses/categories/all';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<CategoryResponse>? _responseData;
    ...
    return Response<BuiltList<CategoryResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<String>>> listCitiesApiV1BusinessesCitiesGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/businesses/cities';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<BusinessResponse>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<BusinessResponse>>> listMyBusinessesApiV1BusinessesMineGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/businesses/mine';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PublicPlatformStats] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PublicPlatformStats>> publicStatsSummaryApiV1BusinessesStatsSummaryGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/businesses/stats/summary';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    PublicPlatformStats? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PublicPlatformStats),
      ) as PublicPlatformStats;
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MessageResponse>> suspendBusinessApiV1BusinessesBusinessIdSuspendPost({ 
    required String businessId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/businesses/{business_id}/suspend'.replaceAll('{' r'business_id' '}', encodeQueryParameter(_serializers, businessId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BusinessResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BusinessResponse>> updateBusinessApiV1BusinessesBusinessIdPatch({ 
    required String businessId,
    required BusinessUpdate businessUpdate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/businesses/{business_id}'.replaceAll('{' r'business_id' '}', encodeQueryParameter(_serializers, businessId, const FullType(String)).toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(BusinessUpdate);
      _bodyData = _serializers.serialize(businessUpdate, specifiedType: _type);
